...
export const generateBadges = async (
  ...
  try {
    ...
    const totalIssuesOpened = await getSearchCount(null, \`repo:\${repository} is:issue created:>=$\${dateOnly}\`, tokenParam);
    const totalIssuesClosed = await getSearchCount(null, \`repo:\${repository} is:issue closed:>=$\${dateOnly}\`, tokenParam);
